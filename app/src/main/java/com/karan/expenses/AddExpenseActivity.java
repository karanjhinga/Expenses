...
public class AddExpenseActivity extends AppCompatActivity {
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(TextUtils.isEmpty(val)){
                    Toast.makeText(AddExpenseActivity.this, "Expense can't be left empty !", Toast.LENGTH_SHORT).show();
                }
                else if(category.getText().toString().equals(DatabaseHelper.Default)){
                    Toast.makeText(AddExpenseActivity.this, "Category must be selected", Toast.LENGTH_SHORT).show();
                }
                else {
                    ...
                    if(databaseHelper.insertRecord(value,DatabaseHelper.TYPE_EXPENSE,category.getText().toString(),description.getText().toString())){
                        ...
                        et.commit();
                        Toast.makeText(AddExpenseActivity.this, "Spent "+value, Toast.LENGTH_SHORT).show();
                        clear();
                    }
                    else {
                        Toast.makeText(AddExpenseActivity.this, "Oops some error occurred !", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
    ...
    private void showDailogtoAddDefaults() {
        AlertDialog.Builder ab = new AlertDialog.Builder(AddExpenseActivity.this);
