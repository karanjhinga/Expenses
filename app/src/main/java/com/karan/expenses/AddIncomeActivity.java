...
public class AddIncomeActivity extends AppCompatActivity {
   ...
   @Override
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(TextUtils.isEmpty(val)){
                    Toast.makeText(AddIncomeActivity.this, "Income can't be left empty !", Toast.LENGTH_SHORT).show();
                }
                else if(category.getText().toString().equals(DatabaseHelper.Default)){
                    Toast.makeText(AddIncomeActivity.this, "Category must be selected", Toast.LENGTH_SHORT).show();
                }
                else {
                    ...
                    if(databaseHelper.insertRecord(value,DatabaseHelper.TYPE_INCOME,category.getText().toString(),description.getText().toString())){
                        ...
                        et.commit();
                        Toast.makeText(AddIncomeActivity.this, "Added "+ value, Toast.LENGTH_SHORT).show();
                        clear();
                    }
                    else {
                        Toast.makeText(AddIncomeActivity.this, "Oops some error occurred !", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
    ...
    private void showDailogtoAddDefaults() {
        AlertDialog.Builder ab = new AlertDialog.Builder(AddIncomeActivity.this);
